...
namespace PresentationLayer.Other
{
    public static class CustomExtensions
    {
        ...
        public static MvcHtmlString TextBoxForReadonly<TModel, TProperty>(
        this HtmlHelper<TModel> helper,
        Expression<Func<TModel, TProperty>> expression)
        {
            return System.Web.Mvc.Html.InputExtensions.TextBoxFor(helper, expression, new { @readonly = "readonly", @style = "background-color :lightgray" });
        }
    }
}